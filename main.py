...
from pp_blueprints import admin_blueprint, guest_blueprint, landing_blueprint, printer_blueprint
from pp_config.configurations import load_config
from pp_config.args import parser
from pp_files import templates_controller
...
app.register_blueprint(templates_controller.bp)
...
app.register_blueprint(printer_blueprint.bp)
